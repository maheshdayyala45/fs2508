...
function App(){
 ...
 <AboutUs/>
    <div className="members">
      {products.map(function(mamb){
       return <Member name={memb.title} city={memb.price}/> 
      
      })}
      {/* <Member name="charan" city="hyd"/> 
     <Member name="maruthi" city="hyd"/> 
     <Member name="valli" city="hyd"/>  */}
    </div>
  </div>
  )
}
